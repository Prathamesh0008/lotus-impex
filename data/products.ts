...
const baseExportProducts: ExportProduct[] = [
  ...
  {
    slug: "solid-slim-fit-tshirts",
    categorySlug: "mens-garments",
    name: "Solid Slim Fit T-Shirts",
    shortName: "Solid Slim Fit",
    type: "T-shirts and polos",
    image:
      "https://images.unsplash.com/photo-1516826957135-700dedea698c?auto=format&fit=crop&w=1400&q=85",
    imageAlt: "Solid slim fit t-shirt for men",
    summary: "Solid slim fit t-shirts for casual menswear retail collections.",
    description:
      "Solid slim fit t-shirts can be sourced in cotton and blended jersey fabrics with buyer-specific color, label and packing requirements.",
    minOrder: "1000 pieces",
    leadTime: "20 - 35 days",
    packaging: "Individual polybag / carton packing",
    origin: "India",
    applications: ["Retail", "Casual wear", "Private label", "Wholesale"],
    specifications: [
      { label: "Product Type", value: "Solid slim fit t-shirts" },
      { label: "Fabric Options", value: "Cotton jersey, blended jersey" },
      { label: "Fit Options", value: "Slim fit, regular fit, custom fit" },
      { label: "Color Options", value: "Solid dyed colors / buyer palette" },
      { label: "Branding", value: "Custom neck label and hang tag" },
    ],
    availableOptions: [
      "Solid slim fit t-shirts",
      "Cotton slim fit t-shirts",
      "Private label t-shirts",
  ...
  },
  {
    ...
    shortName: "Dry Fit T-Shirts",
    type: "T-shirts and polos",
    image:
      "https://images.unsplash.com/photo-1517466787929-bc90951d0974?auto=format&fit=crop&w=1400&q=85",
    imageAlt: "Dry fit t-shirt for men",
    summary: "Dry fit t-shirts for sportswear, activewear and retail supply.",
    description:
      "Dry fit t-shirts are suitable for gym wear, activewear, teamwear and promotional apparel export requirements.",
    minOrder: "1000 pieces",
    leadTime: "20 - 40 days",
    packaging: "Individual polybag / carton packing",
    origin: "India",
    applications: ["Sportswear", "Gym wear", "Teamwear", "Retail"],
    specifications: [
      { label: "Product Type", value: "Dry fit t-shirts" },
      { label: "Fabric Options", value: "Polyester, poly-spandex, performance knits" },
      { label: "Feature Options", value: "Moisture-wicking, stretch, quick dry" },
      { label: "Print Options", value: "Sublimation, screen print, heat transfer" },
      { label: "Packing", value: "Retail or bulk export packing" },
    ],
    availableOptions: [
      "Dry fit gym t-shirts",
      "Running t-shirts",
      "Teamwear t-shirts",
      "Sports t-shirts",
      "Custom active t-shirts",
    ],
  },
  {
    slug: "henley-neck-tshirts",
    categorySlug: "mens-garments",
    name: "Henley Neck T-Shirts",
    shortName: "Henley Neck",
    type: "T-shirts and polos",
    image:
      "https://images.unsplash.com/photo-1617137984095-74e4e5e3613f?auto=format&fit=crop&w=1400&q=85",
    imageAlt: "Henley neck t-shirt for men",
    summary: "Henley neck t-shirts for smart casual menswear collections.",
    description:
      "Henley neck t-shirts can be developed in solid, textured and seasonal knit fabrics for private-label buyers.",
    minOrder: "1000 pieces",
    leadTime: "25 - 40 days",
    packaging: "Individual polybag / carton packing",
    origin: "India",
    applications: ["Smart casual", "Retail", "Boutiques", "Private label"],
    specifications: [
      { label: "Product Type", value: "Henley neck t-shirts" },
      { label: "Fabric Options", value: "Cotton jersey, waffle knit, blended jersey" },
      { label: "Neck Options", value: "Button placket, rib neck, custom trims" },
      { label: "Fit Options", value: "Slim, regular, relaxed" },
      { label: "Branding", value: "Private label and hang tag support" },
    ],
    availableOptions: [
      "Solid henley t-shirts",
      "Long sleeve henley t-shirts",
      "Textured henley t-shirts",
      "Private label henley tees",
      "Custom henley t-shirts",
    ],
  },
  {
    slug: "pure-cotton-tshirts",
    categorySlug: "mens-garments",
    name: "Pure Cotton T-Shirts",
    shortName: "Pure Cotton",
    type: "T-shirts and polos",
    image:
      "https://images.unsplash.com/photo-1576566588028-4147f3842f27?auto=format&fit=crop&w=1400&q=85",
    imageAlt: "Pure cotton t-shirt",
    summary: "Pure cotton t-shirts for basics, retail packs and private labels.",
    description:
      "Pure cotton t-shirts are suitable for everyday menswear ranges, multi-color basics and buyer-specific retail packing.",
    minOrder: "1000 pieces",
    leadTime: "20 - 35 days",
    packaging: "Individual polybag / carton packing",
    origin: "India",
    applications: ["Basics", "Retail packs", "Private label", "Wholesale"],
    specifications: [
      { label: "Product Type", value: "Pure cotton t-shirts" },
      { label: "Fabric Options", value: "100% cotton jersey, combed cotton" },
      { label: "GSM", value: "Buyer requirement based" },
      { label: "Color Options", value: "Solid, melange, seasonal colors" },
      { label: "Packing", value: "Single pack or multipack export packing" },
    ],
    availableOptions: [
      "Cotton basics",
      "Plain cotton t-shirts",
      "Multipack t-shirts",
      "Retail cotton t-shirts",
      "Private label cotton tees",
    ],
  },
  {
    slug: "plus-size-printed-tshirts",
    categorySlug: "mens-garments",
    name: "Plus Size Printed T-Shirts",
    shortName: "Plus Size Printed",
    type: "T-shirts and polos",
    image:
      "https://images.unsplash.com/photo-1520975916090-3105956dac38?auto=format&fit=crop&w=1400&q=85",
    imageAlt: "Plus size printed t-shirt for men",
    summary: "Plus size printed t-shirts for inclusive casualwear ranges.",
    description:
      "Plus size printed t-shirts can be sourced in relaxed fits, graphic prints and extended sizing based on buyer requirements.",
    minOrder: "1000 pieces",
    leadTime: "25 - 40 days",
    packaging: "Individual polybag / carton packing",
    origin: "India",
    applications: ["Inclusive sizing", "Retail", "Streetwear", "Wholesale"],
    specifications: [
      { label: "Product Type", value: "Plus size printed t-shirts" },
      { label: "Fabric Options", value: "Cotton jersey, heavy GSM cotton blends" },
      { label: "Size Range", value: "XL to 5XL / buyer-specific sizing" },
      { label: "Print Options", value: "Screen print, digital print, puff print" },
      { label: "Fit Options", value: "Relaxed, oversized, plus fit" },
    ],
    availableOptions: [
      "Plus size graphic t-shirts",
      "Relaxed printed t-shirts",
      "Oversized plus t-shirts",
      "Custom plus size t-shirts",
      "Bulk plus size tees",
    ],
  },
  {
    slug: "sleeveless-vest-tshirts",
    categorySlug: "mens-garments",
    name: "Sleeveless Vest T-Shirts",
    shortName: "Vest T-Shirts",
    type: "T-shirts and polos",
    image:
      "https://images.unsplash.com/photo-1552374196-1ab2a1c593e8?auto=format&fit=crop&w=1400&q=85",
    imageAlt: "Sleeveless vest style t-shirt for men",
    summary: "Sleeveless vest t-shirts for gym, summer and streetwear buyers.",
    description:
      "Sleeveless vest t-shirts can be produced in cotton and performance fabrics for activewear and casualwear collections.",
    minOrder: "1000 pieces",
    leadTime: "20 - 35 days",
    packaging: "Individual polybag / carton packing",
    origin: "India",
    applications: ["Gym wear", "Summer wear", "Streetwear", "Retail"],
    specifications: [
      { label: "Product Type", value: "Sleeveless vest t-shirts" },
      { label: "Fabric Options", value: "Cotton jersey, rib knit, performance blends" },
      { label: "Fit Options", value: "Regular, muscle fit, relaxed fit" },
      { label: "Print Options", value: "Logo print, graphic print, embroidery" },
      { label: "Branding", value: "Private label support available" },
    ],
    availableOptions: [
      "Gym vest t-shirts",
      "Sleeveless cotton t-shirts",
      "Muscle fit t-shirts",
      "Streetwear vest tees",
      "Custom sleeveless t-shirts",
    ],
  },
